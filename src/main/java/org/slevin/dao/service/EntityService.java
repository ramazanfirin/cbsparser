...
public abstract class EntityService<E>  implements EntityDao<E> {
	...
	@Transactional(readOnly = true)
	@SuppressWarnings("unchecked")
	public List<E> findUncomplatedList() throws Exception{
        return getEntityManager().createQuery("Select t from " + getEntityClass().getSimpleName() + " t where t.complated=false").getResultList();
	}
	...
	@Transactional(readOnly = true)
	@SuppressWarnings("unchecked")
	public E findByPropertySingleResult(String prop, Object val) throws Exception {
        return (E) getEntityManager().createQuery("select x from " + getEntityClass().getSimpleName() + " x where x." + prop + " = ?1").setParameter(1, val).getSingleResult();
    }
	...
	public void setEntityManager(EntityManager entityManager) throws Exception{
	   ...
	   if (entityClass == null) {
	    ...
	    public void merge(List<E> list) throws Exception {
...
//		public long complatedCount(String ilceName) throws Exception {
//			return (Long) getEntityManager().createQuery("Select count(t) from " + getEntityClass().getSimpleName() + " t where t.complated=1").getSingleResult();
//		}
//		public long unComplatedcount(String ilceName) throws Exception {
//			return (Long) getEntityManager().createQuery("Select count(t) from " + getEntityClass().getSimpleName() + " t where t.complated=0").getSingleResult();
//		}
